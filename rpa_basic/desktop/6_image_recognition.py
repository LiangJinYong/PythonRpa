...
# add_terminal_icon = pyautogui.locateOnScreen("add_terminal_icon.png")
# pyautogui.moveTo(add_terminal_icon)
...
# 속도 개선
# 1. GrayScale
# add_terminal_icon = pyautogui.locateOnScreen("add_terminal_icon.png", grayscale=True)
# pyautogui.moveTo(add_terminal_icon)

# 2. 범위 지정
# add_terminal_icon = pyautogui.locateOnScreen("add_terminal_icon.png", region=(2000, 900, 500, 500))
# pyautogui.moveTo(add_terminal_icon)
